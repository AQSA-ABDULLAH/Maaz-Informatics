    ...
    <div className={styles.sectionContainer}>
      ...
      <div className={`${styles.stepContainer} ${styles.stepReverse}`}>
        <div className={styles.textContainer}>
          ...
          <ul>
            ...
            <li>Wysa's AI is clinically proven to create a therapeutic alliance equivalent to a human therapist within the first week.</li>
      ...
      <div className={styles.stepContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <ul>
            <li>Wysa's AI conversational care guides users through both curated CBT programs and on-demand support.</li>
            <li>In Wysa's Clinical Programs, the AI checks in every morning and evening, and can also be supplemented by a human coach or therapist. The programs are clinically validated to reduce symptoms of depression and anxiety.</li>
      ...
      <div className={`${styles.stepContainer} ${styles.stepReverse}`}>
        <div className={styles.textContainer}>
          ...
          <ul>
            <li>Wysa coaches offer 1-on-1 sessions, along with unlimited messaging between sessions. If chosen, employees can also be redirected to in-house EAP support through Wysa</li>
            <li>Wysa's conversational AI takes on 80% of the load by supporting people with sub-clinical symptom levels and guiding them through proactive prevention routines</li>
      ...
      <div className={styles.stepContainer}>
        ...
        <div className={styles.textContainer}>
          ...
          <ul>
            <li>Wysa's SOS feature guides people toward local and national crisis care helplines.</li>
            <li>The SOS feature also offers the ability to create a personal safety plan and practice grounding exercises.</li>
            <li>Wysa's AI continuously screens for people in crisis and facilitates signposting to local helplines.</li>
          </ul>
        </div>
      </div>
    </div>
