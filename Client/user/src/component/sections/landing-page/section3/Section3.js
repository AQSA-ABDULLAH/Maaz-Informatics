    ...
    <>
      <div className={styles.section3}>
        ...
        <p>{WEBSITE_NAME} has held over half a billion AI chat conversations with more than five million
          ...
          employee mental health led us to conduct in-depth studies of employees in USA and UK,
        ...
        <div className={styles.section_container}>
          <div className={styles.section_item}>
            ...
            <p>Our research shows that as many as <strong>4 in 10 employees suffer from symptoms of depression or anxiety</strong>, yet less than 7% access EAP due to stigma, lack of awareness and time constraints. While talking to Wysa, <strong>42% of employees opened up about their declining mental health.</strong></p>
          </div>
          <div className={styles.section_item}>
          ...
          <div className={styles.section_item}>
            ...
            <p>The emotional bond people build with Wysa is as deep as that with a human therapist, and <strong>9 in 10 users find talking to Wysa helpful.</strong> AI-led support has been proven to improve symptoms while taking on <strong>80% of the support load</strong>, to free up human support for where it's really needed.</p>
          </div>
        </div>
